...
function prepend(e) {
  ...
  for (s = 0; s < this.length; s += 1)
    ...
    } else if (e instanceof Dom7) for (a = 0; a < e.length; a += 1) this[s].insertBefore(e[a], this[s].childNodes[0])
...
function getTranslate(e, t = "x") {
  ...
  return (
    s.WebKitCSSMatrix
      ...
      : ((r = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")), (a = r.toString().split(","))),
  ...
  for (let i = 0; i < p; i += 1) {
    ...
    if (($ && e.grid.updateSlide(i, n, p, t), "none" !== n.css("display"))) {
      if ("auto" === a.slidesPerView) {
        ...
        if ((l && (n[0].style.transform = "none"), o && (n[0].style.webkitTransform = "none"), a.roundLengths)) T = e.isHorizontal() ? n.outerWidth(!0) : n.outerHeight(!0)
        else {
          const e = s(r, "width"),
            t = s(r, "padding-left"),
            a = s(r, "padding-right"),
      ...
      c[i] && (c[i].swiperSlideSize = T), m.push(T), a.centeredSlides ? ((x = x + T / 2 + y / 2 + b), 0 === y && 0 !== i && (x = x - r / 2 - b), 0 === i && (x = x - r / 2 - b), Math.abs(x) < 0.001 && (x = 0), a.roundLengths && (x = Math.floor(x)), E % a.slidesPerGroup == 0 && u.push(x), h.push(x)) : (a.roundLengths && (x = Math.floor(x)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup == 0 && u.push(x), h.push(x), (x = x + T + b)), (e.virtualSize += T + b), (y = T), (E += 1)
    }
  }
  if (((e.virtualSize = Math.max(e.virtualSize, r) + g), n && l && ("slide" === a.effect || "coverflow" === a.effect) && i.css({ width: `${e.virtualSize + a.spaceBetween}px` }), a.setWrapperSize && i.css({ [t("width")]: `${e.virtualSize + a.spaceBetween}px` }), $ && e.grid.updateWrapperSize(T, u, t), !a.centeredSlides)) {
    const t = []
...
function translateTo(e = 0, t = this.params.speed, s = !0, a = !0, i) {
  ...
  if (((c = a && e > o ? o : a && e < d ? d : e), r.updateProgress(c), n.cssMode)) {
    ...
    if (0 === t) l[e ? "scrollLeft" : "scrollTop"] = -c
      ...
      if (!r.support.smoothScroll) return animateCSSModeScroll({ swiper: r, targetPosition: -c, side: e ? "left" : "top" }), !0
...
var translate = { getTranslate: getSwiperTranslate, setTranslate: setTranslate, minTranslate: minTranslate, maxTranslate: maxTranslate, translateTo: translateTo }
...
function transitionEnd(e = !0, t) {
  const s = this,
    { params: a } = s
  ;(s.animating = !1), a.cssMode || (s.setTransition(0), transitionEmit({ swiper: s, runCallbacks: e, direction: t, step: "End" }))
}
...
function slideTo(e = 0, t = this.params.speed, s = !0, a, i) {
  ...
  if (l.cssMode) {
    ...
    if (0 === t) {
      ...
      if (!r.support.smoothScroll) return animateCSSModeScroll({ swiper: r, targetPosition: s, side: e ? "left" : "top" }), !0
  ...
  return (
    0 === t
      ? (r.setTransition(0), r.setTranslate(v), r.updateActiveIndex(n), r.updateSlidesClasses(), r.emit("beforeTransitionStart", t, a), r.transitionStart(s, w), r.transitionEnd(s, w))
      : (r.setTransition(t),
        r.setTranslate(v),
...
function onTouchStart(e) {
  ...
  if ((Object.assign(i, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }), (n.startX = u), (n.startY = h), (i.touchStartTime = now()), (t.allowClick = !0), t.updateSize(), (t.swipeDirection = void 0), r.threshold > 0 && (i.allowThresholdMove = !1), "touchstart" !== o.type)) {
    let e = !0
...
function onTouchMove(e) {
  ...
  if (!s.allowTouchMove) return (s.allowClick = !1), void (a.isTouched && (Object.assign(r, { startX: c, startY: p, currentX: c, currentY: p }), (a.touchStartTime = now())))
...
const events = (e, t) => {
  const s = getDocument(),
    ...
    p = t
  if (o.touch) {
    const t = !("touchstart" !== i.start || !o.passiveListener || !a.passiveListeners) && { passive: !0, capture: !1 }
    r[c](i.start, e.onTouchStart, t), r[c](i.move, e.onTouchMove, o.passiveListener ? { passive: !1, capture: d } : d), r[c](i.end, e.onTouchEnd, t), i.cancel && r[c](i.cancel, e.onTouchEnd, t)
...
const prototypes = { eventsEmitter: eventsEmitter, update: update, translate: translate, transition: transition, slide: slide, loop: loop, grabCursor: grabCursor, events: events$1, breakpoints: breakpoints, checkOverflow: checkOverflow$1, classes: classes, images: images },
  extendedDefaults = {}
class Swiper {
  constructor(...e) {
    let t, s
    ...
    const a = this
    ;(a.__swiper__ = !0), (a.support = getSupport()), (a.device = getDevice({ userAgent: s.userAgent })), (a.browser = getBrowser()), (a.eventsListeners = {}), (a.eventsAnyListeners = []), (a.modules = [...a.__modules__]), s.modules && Array.isArray(s.modules) && a.modules.push(...s.modules)
    const i = {}
    a.modules.forEach((e) => {
      e({ swiper: a, extendParams: moduleExtendParams(s, i), on: a.on.bind(a), once: a.once.bind(a), off: a.off.bind(a), emit: a.emit.bind(a) })
    })
    ...
    return (
      ...
      Object.assign(a, {
        ...
        touchEventsData: { isTouched: void 0, isMoved: void 0, allowTouchCallbacks: void 0, touchStartTime: void 0, isScrolling: void 0, currentTranslate: void 0, startTranslate: void 0, allowThresholdMove: void 0, focusableElements: a.params.focusableElements, lastClickTime: now(), clickTimeout: void 0, velocities: [], allowMomentumBounce: void 0, isTouchEvent: void 0, startMoving: void 0 },
        allowClick: !0,
  ...
  mount(e) {
    ...
    return Object.assign(t, { $el: s, el: e, $wrapperEl: i, wrapperEl: i[0], mounted: !0, rtl: "rtl" === e.dir.toLowerCase() || "rtl" === s.css("direction"), rtlTranslate: "horizontal" === t.params.direction && ("rtl" === e.dir.toLowerCase() || "rtl" === s.css("direction")), wrongRTL: "-webkit-box" === i.css("display") }), !0
  }
  init(e) {
    const t = this
...
function Navigation({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function d() {
    ...
    if (((e.params.navigation = createElementIfNotDefined(e, e.originalParams.navigation, e.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), !t.nextEl && !t.prevEl)) return
    const s = i(t.nextEl),
      a = i(t.prevEl)
...
function Pagination({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function d() {
    ...
    if ((e.params.loop ? ((c = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)), c > i - 1 - 2 * e.loopedSlides && (c -= i - 2 * e.loopedSlides), c > p - 1 && (c -= p), c < 0 && "bullets" !== e.params.paginationType && (c = p + c)) : (c = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0), "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0)) {
      ...
      let i, l, p
      if ((s.dynamicBullets && ((r = a.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0)), d.css(e.isHorizontal() ? "width" : "height", r * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((n += c - e.previousIndex), n > s.dynamicMainBullets - 1 ? (n = s.dynamicMainBullets - 1) : n < 0 && (n = 0)), (i = c - n), (l = i + (Math.min(a.length, s.dynamicMainBullets) - 1)), (p = (l + i) / 2)), a.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e) => `${s.bulletActiveClass}${e}`).join(" ")), d.length > 1))
        a.each((e) => {
          const t = $(e),
            a = t.index()
  ...
  function p() {
    ...
    let s = $(t.el)
    0 !== s.length &&
      (e.params.uniqueNavElements && "string" == typeof t.el && s.length > 1 && ((s = e.$el.find(t.el)), s.length > 1 && (s = s.filter((t) => $(t).parents(".swiper")[0] === e.el))),
...
function Scrollbar({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function u() {
    ...
    let d = n,
      p = (l - n) * a
    s ? ((p = -p), p > 0 ? ((d = n - p), (p = 0)) : -p + n > l && (d = l + p)) : p < 0 ? ((d = n + p), (p = 0)) : p + n > l && (d = l - p),
  ...
  function x() {
    ...
    0 === r.length && ((r = $(`<div class="${e.params.scrollbar.dragClass}"></div>`)), i.append(r)), Object.assign(t, { $el: i, el: i[0], $dragEl: r, dragEl: r[0] }), a.draggable && e.params.scrollbar.el && b("on"), i && i[e.enabled ? "removeClass" : "addClass"](e.params.scrollbar.lockClass)
  }
  function y() {
...
function Zoom({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  let r,
    ...
    o = 1,
    d = !1
  const c = { $slideEl: void 0, slideWidth: void 0, slideHeight: void 0, $imageEl: void 0, $imageWrapEl: void 0, maxRatio: 3 },
    p = { isTouched: void 0, isMoved: void 0, currentX: void 0, currentY: void 0, minX: void 0, minY: void 0, maxX: void 0, maxY: void 0, width: void 0, height: void 0, startX: void 0, startY: void 0, touchesStart: {}, touchesCurrent: {} },
  ...
  function g(t) {
    ...
    c.$imageEl && 0 !== c.$imageEl.length ? (s.gestures ? (i.scale = t.scale * o) : (i.scale = (c.scaleMove / c.scaleStart) * o), i.scale > c.maxRatio && (i.scale = c.maxRatio - 1 + (i.scale - c.maxRatio + 1) ** 0.5), i.scale < a.minRatio && (i.scale = a.minRatio + 1 - (a.minRatio - i.scale + 1) ** 0.5), c.$imageEl.transform(`translate3d(0,0,0) scale(${i.scale})`)) : "gesturechange" === t.type && f(t)
  }
  function v(t) {
    const s = e.device,
      a = e.support,
...
function Lazy({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function o() {
    ...
    const h = !("touchstart" !== e.touchEvents.start || !e.support.passiveListener || !e.params.passiveListeners) && { passive: !0, capture: !1 }
...
function A11y({ swiper: e, extendParams: t, on: s }) {
  ...
  function g() {
    ...
    e.slides.each((s, a) => {
      ...
      m() && e.pagination.$el.on("keydown", classesToSelector(e.params.pagination.bulletClass), u)
  }
  s("beforeInit", () => {
...
function History({ swiper: e, extendParams: t, on: s }) {
  ...
  const r = (e) =>
    ...
    l = (t, s) => {
      ...
      ;(d && d.value === o) || (e.params.history.replaceState ? i.history.replaceState({ value: o }, null, o) : i.history.pushState({ value: o }, null, o))
    },
    o = (t, s, a) => {
      if (s)
    ...
    Object.assign(e, {
      freeMode: {
        onTouchMove: function () {
          ...
          0 === t.velocities.length && t.velocities.push({ position: s[e.isHorizontal() ? "startX" : "startY"], time: t.touchStartTime }), t.velocities.push({ position: s[e.isHorizontal() ? "currentX" : "currentY"], time: now() })
        },
        onTouchEnd: function ({ currentPos: t }) {
          ...
          if (t < -e.minTranslate()) e.slideTo(e.activeIndex)
            ...
            if (i.freeMode.momentum) {
              ...
              let m
              if (c < e.maxTranslate()) i.freeMode.momentumBounce ? (c + e.maxTranslate() < -h && (c = e.maxTranslate() - h), (p = e.maxTranslate()), (u = !0), (o.allowMomentumBounce = !0)) : (c = e.maxTranslate()), i.loop && i.centeredSlides && (m = !0)
              else if (c > e.minTranslate()) i.freeMode.momentumBounce ? (c - e.minTranslate() > h && (c = e.minTranslate() + h), (p = e.minTranslate()), (u = !0), (o.allowMomentumBounce = !0)) : (c = e.minTranslate()), i.loop && i.centeredSlides && (m = !0)
...
function EffectFade({ swiper: e, extendParams: t, on: s }) {
  ...
  effectInit({
    ...
    setTransition: (t) => {
      ...
      ;(s ? e.slides.find(s) : e.slides).transition(t), effectVirtualTransitionEnd({ swiper: e, duration: t, transformEl: s, allSlides: !0 })
    },
...
function EffectCube({ swiper: e, extendParams: t, on: s }) {
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      let u,
        h = 0
      d.shadow && (c ? ((u = s.find(".swiper-cube-shadow")), 0 === u.length && ((u = $('<div class="swiper-cube-shadow"></div>')), s.append(u)), u.css({ height: `${i}px` })) : ((u = t.find(".swiper-cube-shadow")), 0 === u.length && ((u = $('<div class="swiper-cube-shadow"></div>')), t.append(u))))
      for (let e = 0; e < a.length; e += 1) {
        const t = a.eq(e)
        let s = e
      ...
      if ((s.css({ "-webkit-transform-origin": `50% 50% -${l / 2}px`, "transform-origin": `50% 50% -${l / 2}px` }), d.shadow))
        if (c) u.transform(`translate3d(0px, ${i / 2 + d.shadowOffset}px, ${-i / 2}px) rotateX(90deg) rotateZ(0deg) scale(${d.shadowScale})`)
        else {
...
function EffectFlip({ swiper: e, extendParams: t, on: s }) {
  ...
  effectInit({
    ...
    setTransition: (t) => {
      ...
      ;(s ? e.slides.find(s) : e.slides).transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t), effectVirtualTransitionEnd({ swiper: e, duration: t, transformEl: s })
    },
    perspective: () => !0,
    overwriteParams: () => ({ slidesPerView: 1, slidesPerGroup: 1, watchSlidesProgress: !0, spaceBetween: 0, virtualTranslate: !e.params.cssMode }),
  })
...
function EffectCreative({ swiper: e, extendParams: t, on: s }) {
  ...
  effectInit({
    ...
    setTransition: (t) => {
      ...
      ;(s ? e.slides.find(s) : e.slides).transition(t).find(".swiper-slide-shadow").transition(t), effectVirtualTransitionEnd({ swiper: e, duration: t, transformEl: s, allSlides: !0 })
    },
...
function EffectCards({ swiper: e, extendParams: t, on: s }) {
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      for (let l = 0; l < t.length; l += 1) {
        ...
        if (a.slideShadows) {
          ...
          0 === e.length && (e = createShadow(a, o)), e.length && (e[0].style.opacity = Math.min(Math.max((Math.abs(c) - 0.5) / 0.5, 0), 1))
        }
    ...
    setTransition: (t) => {
      ...
      ;(s ? e.slides.find(s) : e.slides).transition(t).find(".swiper-slide-shadow").transition(t), effectVirtualTransitionEnd({ swiper: e, duration: t, transformEl: s })
    },
    perspective: () => !0,
    overwriteParams: () => ({ watchSlidesProgress: !0, virtualTranslate: !e.params.cssMode }),
  })
